(function ($) {
  ...
  const countDown = function () {
    ...
    //   document.querySelector(".hours").textContent = await Math.floor(
    //     (distance % day) / hour
    //   );
    //   document.querySelector(".minutes").textContent = await Math.floor(
    //     (distance % hour) / minute
    //   );
    //   document.querySelector(".seconds").textContent = await Math.floor(
